...
function filter_smilies(s) {
	for (var i = 0; i < smilies.length; i++) {
		...
		var imgsrc = 'http://localhost/notebook/wp-includes/images/smilies/' + smilies[i][1];
...
var GetChaturl  = 'http://localhost/notebook/wp-content/plugins/simple-ajax-chat/simple-ajax-chat-core.php?sacGetChat=yes';
var SendChaturl = 'http://localhost/notebook/wp-content/plugins/simple-ajax-chat/simple-ajax-chat-core.php?sacSendChat=yes';
...
function receiveChatText() {
	...
	if (httpReceiveChat.readyState == 4 || httpReceiveChat.readyState == 0) {
		...
		var nonce = '&sac_nonce_receive=5223fdf285';
...
function insertNewContent(liName,liText,lastResponse, liUrl, liId) {
	...
	insertO.insertBefore(oLi, insertO.firstChild);
		...
		jQuery.post('http://localhost/notebook/wp-content/plugins/simple-ajax-chat/includes/sac-check-user.php', 'sac_user=' + encodeURIComponent(liName), function(response){
...
function checkName() {
	...
	if (chat_name != sacCookie) {
		document.cookie = 'sacUserName=' + chat_name + '; expires=Sun, 28 Nov 2021 15:56:58 UTC; samesite=strict;';
	}
...
function checkUrl() {
	...
	if (currentName.value != sacCookie) {
		document.cookie = 'sacUrl=' + currentName.value + '; expires=Sun, 28 Nov 2021 15:56:58 UTC; samesite=strict;';
		return;
	}
...
jQuery(document).ready(function($){
	...
	// nonce
	var url = 'http://localhost/notebook/wp-content/plugins/simple-ajax-chat/resources/nonce.php';
...
function sacCustomNotify(title, desc, url) {
	if (window.Notification && Notification.permission == 'granted') {
		var notification = new Notification(title, {
			icon: 'http://localhost/notebook/wp-content/plugins/simple-ajax-chat/resources/sac-400.png',
			body: desc,
		});
		if (url) {
